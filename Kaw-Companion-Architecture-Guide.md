...
Version 2.5 expands the role of communication within the architecture.
...
# Chapter 14 — Communication Specification

The purpose of the Communication Specification is to transform deterministic instructional intent into a complete communication plan before artificial intelligence generates any instructional response.

The Communication Specification serves as the governed interface between the deterministic instructional engine and artificial intelligence.

It does not determine instruction.

It communicates predetermined instruction.

Every instructional response generated by Kaw Companion begins with a Communication Specification.

---

## Purpose

The Communication Specification answers one question:

> **Given the instructional intent already determined, what information must artificial intelligence receive to express that intent faithfully and naturally?**

Artificial intelligence does not infer instructional purpose.

Artificial intelligence receives instructional purpose.

This distinction preserves deterministic instructional authority while allowing communication to remain adaptive and conversational.

---

## Structure of the Communication Specification

Every Communication Specification consists of five governed sections.

### 1. Instructional Intent

Instructional Intent identifies the deterministic instructional decision established by the instructional engine.

Examples include:

* Celebrate student success
* Clarify a misconception
* Prompt the next thinking step
* Request revision
* Provide a scaffold
* Confirm understanding
* Recover from uncertainty

Instructional Intent establishes **what** communication must accomplish.

---

### 2. Communication Requirements

Communication Requirements define the instructional characteristics that must be preserved.
...
* Reinforce Framing Routine vocabulary.
* Maintain instructional continuity.
* Build from prior success.
* Respect the current Support Level.

These requirements establish **how** communication must behave.

---

### 3. Communication Context

Communication Context provides the information necessary for natural communication.

Examples include:

* Current instructional component
* Student artifact
...
Communication Context explains **what the AI needs to know** before generating a response.

---

### 4. Communication Constraints

Communication Constraints establish constitutional boundaries that communication may not violate.

Examples include:

* Do not complete student thinking.
* Do not alter instructional intent.
* Do not advance progression prematurely.
* Maintain deterministic instructional goals.
* Preserve instructional terminology.
* Remain aligned to the current instructional contract.

These constraints ensure that flexibility never replaces governance.

---

### 5. Expected Student Outcome

The Communication Specification concludes by defining the instructional outcome the response should encourage.

Examples include:

* Student identifies one Main Idea.
* Student revises an Is About statement.
* Student provides additional evidence.
* Student confirms instructional understanding.
* Student continues to the next thinking step.

Expected Outcome defines **the instructional purpose of the response**, not the wording of the response itself.

---

## Constitutional Summary

The Communication Specification does not generate instructional language.

It establishes the deterministic instructional requirements that govern communication.

Artificial intelligence remains responsible for natural expression.

The deterministic instructional engine remains responsible for instructional intent.

By separating instructional planning from instructional expression, Kaw Companion preserves deterministic governance while allowing communication to remain authentic, flexible, and conversational.
...
Its responsibility is to transform a completed Communication Specification into natural instructional communication while faithfully preserving every instructional requirement established by the deterministic instructional engine.

Artificial intelligence therefore functions as an instructional expression engine rather than an instructional decision-maker.

---

## Purpose

AI Contextualization answers one question:

> **How can predetermined instructional intent be expressed naturally without altering the instructional decision itself?**

Artificial intelligence contributes natural language.

It does not contribute instructional reasoning.

---

## Inputs

Artificial intelligence receives a completed Communication Specification.
...
Together these elements define every instructional boundary required for communication.

---

## Responsibilities

Artificial intelligence may adapt:
...
These adaptations improve the student experience while preserving deterministic instructional governance.

---

## Constitutional Boundaries

Artificial intelligence may never alter:
...
If multiple acceptable responses are possible, artificial intelligence may select any response that remains completely consistent with the Communication Specification.

---

## Relationship to Communication Validation

Every AI-generated response is subsequently evaluated through Communication Validation.

Communication Validation confirms that the generated communication:

* preserves instructional intent,
* satisfies the Communication Requirements,
* respects all Communication Constraints,
* supports the Expected Student Outcome,
* and remains aligned with constitutional governance.

Only after successful validation is communication delivered to the student.

---

## Constitutional Summary

Artificial intelligence provides natural instructional communication.

It does not provide instructional authority.

The deterministic instructional engine determines **what** should occur.

The Communication Specification defines **how that instruction must be represented.**

Artificial intelligence determines **how to express that representation naturally.**

Communication Validation confirms that the generated response faithfully preserves deterministic instructional intent before it reaches the student.

Together these governed layers ensure that Kaw Companion combines deterministic instructional reasoning with the flexibility of natural language while preserving constitutional governance.
